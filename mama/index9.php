...
<body>
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-md-2">
				<h2 class='text-uppercase'><?= $content ?> Data kelas SMK</h2>
			</div>
			<div class="col-md-10">
			<?php
			...
			switch ($content) {
				case 'add':
					require 'operasi9/create9.php';
					break;
				case 'delete':
					require 'operasi9/delete9.php';
					break;
				case 'update':
					require 'operasi9/update9.php';
					break;
				default:
					require 'operasi9/read9.php';
					break;
			} ?>
			</div>
		</div>
