<?php 
$query = "SELECT * FROM absen_siswa ORDER BY id_absen_siswa DESC";
...
<head>
	...
	<title>Data absen_siswa SMK</title>
...
<body>
    <a href="<?= $WEB_CONFIG['base_url'] ?>index7.php?page=add" class="btn btn-primary mb-3">
...
<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
		...
		<tbody>
			...
			<tr>
				...
				<td>
					<a href="<?= $WEB_CONFIG['base_url'] ?>index7.php?page=update&id_absen_siswa=<?= $data['id_absen_siswa'] ?>" class="btn btn-success m-1">
					...
					<a href="javascript:alertDelete(<?= $data['id_absen_siswa'] ?>);" class="btn btn-danger m1">
					<svg style="width:20px;height:20px" viewBox="0 0 24 24" class="mb-1">
...
function alertDelete(idn) {
	$('#deleteButtonModal').attr('href', '<?= $WEB_CONFIG['base_url'] ?>index7.php?page=delete&id_absen_siswa='+idn);
