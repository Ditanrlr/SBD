<?php 
$query = "SELECT * FROM nilai ORDER BY id_nilai DESC";
...
<body>
    <a href="<?= $WEB_CONFIG['base_url'] ?>index10.php?page=add" class="btn btn-primary mb-3">
...
<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
        ...
        <td><?= $data['bobot_nilai'] ?></td>
				<td>
					<a href="<?= $WEB_CONFIG['base_url'] ?>index10.php?page=update&id_nilai=<?= $data['id_nilai'] ?>" class="btn btn-success m-1">
					...
					<a href="javascript:alertDelete(<?= $data['id_nilai'] ?>);" class="btn btn-danger m1">
					<svg style="width:20px;height:20px" viewBox="0 0 24 24" class="mb-1">
...
function alertDelete(idn) {
	$('#deleteButtonModal').attr('href', '<?= $WEB_CONFIG['base_url'] ?>index10.php?page=delete&id_nilai='+idn);
