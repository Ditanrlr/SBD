<?php 
$query = "SELECT * FROM mata_pelajaran ORDER BY id_mata_pelajaran DESC";
...
<head>
	...
	<title>Data mata_pelajaran SMK</title>
...
<body>
    <a href="<?= $WEB_CONFIG['base_url'] ?>indexp.php?page=add" class="btn btn-primary mb-3">
...
<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
		...
		<tbody>
			...
			<tr>
				...
				<td><?= $data['guru_pengajar'] ?></td>
				<td><?= $data['tingkat_kelas'] ?></td>
				<td>
					<a href="<?= $WEB_CONFIG['base_url'] ?>indexp.php?page=update&id_mata_pelajaran=<?= $data['id_mata_pelajaran'] ?>" class="btn btn-success m-1">
					...
					<a href="javascript:alertDelete(<?= $data['id_mata_pelajaran'] ?>);" class="btn btn-danger m1">
					<svg style="width:20px;height:20px" viewBox="0 0 24 24" class="mb-1">
...
function alertDelete(idn) {
	$('#deleteButtonModal').attr('href', '<?= $WEB_CONFIG['base_url'] ?>indexp.php?page=delete&id_mata_pelajaran='+idn);
