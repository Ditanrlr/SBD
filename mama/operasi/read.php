...
<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
        ...
        <td><?= $data['alamat'] ?></td>
				<td>
					<a href="<?= $WEB_CONFIG['base_url'] ?>index.php?page=update&id_Siswa=<?= $data['id_Siswa'] ?>" class="btn btn-success m-1">
					...
					<a href="javascript:alertDelete(<?= $data['id_Siswa'] ?>);" class="btn btn-danger m1">
					<svg style="width:20px;height:20px" viewBox="0 0 24 24" class="mb-1">
...
function alertDelete(idn) {
	$('#deleteButtonModal').attr('href', '<?= $WEB_CONFIG['base_url'] ?>index.php?page=delete&id_Siswa='+idn);
