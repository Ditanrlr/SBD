...
<body>
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-md-2">
				<h2 class='text-uppercase'><?= $content ?> Data mata_pelajaran SMK</h2>
			</div>
			<div class="col-md-10">
			<?php
			...
			switch ($content) {
				case 'add':
					require 'operasip/createp.php';
					break;
				case 'delete':
					require 'operasip/deletep.php';
					break;
				case 'update':
					require 'operasip/updatep.php';
					break;
				default:
					require 'operasip/readp.php';
					break;
			} ?>
			</div>
		</div>
