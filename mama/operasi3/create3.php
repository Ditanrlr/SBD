...
<div class="container">
	<form action="" method="post">
		...
		<div class="form-group">
			...
			<input type="Jabatan" name="Jabatan" class="form-control" id="inputNIM" maxlength="30" required>
			<small class="text-danger"><?= $JabatanErr == "" ? "":"* $ISNrr" ?></small>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<input type="text" name="Agama" class="form-control" id="inputAgama" maxlength="40" required autofocus>
