<?php 
$query = "SELECT * FROM ekstrakulikuler ORDER BY id_ekstrakulikuler DESC";
...
<head>
	...
	<title>Data ekstrakulikuler SMK</title>
...
<body>
    <a href="<?= $WEB_CONFIG['base_url'] ?>index6.php?page=add" class="btn btn-primary mb-3">
...
<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
		<thead>
			<tr>
				<th>id_ekstrakulikuler</th>
				<th>Siswa_id_Siswa</th>
				<th>Nama_siswa</th>
				<th>nama_ekstrakulikuler</th>
				<th>tingkat_kelas</th>
		...
		<tbody>
			...
			<tr>
				...
				<td>
					<a href="<?= $WEB_CONFIG['base_url'] ?>index6.php?page=update&id_ekstrakulikuler=<?= $data['id_ekstrakulikuler'] ?>" class="btn btn-success m-1">
					...
					<a href="javascript:alertDelete(<?= $data['id_ekstrakulikuler'] ?>);" class="btn btn-danger m1">
					<svg style="width:20px;height:20px" viewBox="0 0 24 24" class="mb-1">
...
function alertDelete(idn) {
	$('#deleteButtonModal').attr('href', '<?= $WEB_CONFIG['base_url'] ?>index6.php?page=delete&id_ekstrakulikuler='+idn);
