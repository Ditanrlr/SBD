...
<body>
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-md-2">
				<h2 class='text-uppercase'><?= $content ?> Data absen_siswa SMK</h2>
			</div>
			<div class="col-md-10">
			<?php
			...
			switch ($content) {
				case 'add':
					require 'operasi7/create7.php';
					break;
				case 'delete':
					require 'operasi7/delete7.php';
					break;
				case 'update':
					require 'operasi7/update7.php';
					break;
				default:
					require 'operasi7/read7.php';
					break;
			} ?>
			</div>
		</div>
