<?php 
$query = "SELECT * FROM kurikulum ORDER BY id_kurikulum DESC";
...
<head>
	...
	<title>Data kurikulum SMK</title>
...
<body>
    <a href="<?= $WEB_CONFIG['base_url'] ?>indexk.php?page=add" class="btn btn-primary mb-3">
...
<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
		<thead>
			<tr>
				<th>id_kurikulum</th>
				<th>mata_pelajaran_id_mata_pelajaran</th>
				<th>mata_pelajaran</th>
				<th>nama_kurikulum</th>
				<th>status_kurikulum</th>
		...
		<tbody>
			...
			<tr>
				<td><?= $no ?></td>
				<td><?= $data['mata_pelajaran_id_mata_pelajaran'] ?></td>
				<td><?= $data['mata_pelajaran'] ?></td>
				<td><?= $data['nama_kurikulum'] ?></td>
				<td><?= $data['status_kurikulum'] ?></td>
				<td>
					<a href="<?= $WEB_CONFIG['base_url'] ?>indexk.php?page=update&id_kurikulum=<?= $data['id_kurikulum'] ?>" class="btn btn-success m-1">
					...
					<a href="javascript:alertDelete(<?= $data['id_kurikulum'] ?>);" class="btn btn-danger m1">
					<svg style="width:20px;height:20px" viewBox="0 0 24 24" class="mb-1">
...
function alertDelete(idn) {
	$('#deleteButtonModal').attr('href', '<?= $WEB_CONFIG['base_url'] ?>indexk.php?page=delete&id_kurikulum='+idn);
