<?php 
$query = "SELECT * FROM absen_guru ORDER BY id_absen_guru DESC";
...
<head>
	...
	<title>Data absen_guru SMK</title>
...
<body>
    <a href="<?= $WEB_CONFIG['base_url'] ?>index8.php?page=add" class="btn btn-primary mb-3">
...
<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
		...
		<tbody>
			...
			<tr>
				<td><?= $no ?></td>
				<td><?= $data['guru_id_guru'] ?></td>
				<td><?= $data['nama_lengkap'] ?></td>
				<td><?= $data['tanggal'] ?></td>
				<td><?= $data['keterangan'] ?></td>
				<td>
					<a href="<?= $WEB_CONFIG['base_url'] ?>index8.php?page=update&id_absen_guru=<?= $data['id_absen_guru'] ?>" class="btn btn-success m-1">
					...
					<a href="javascript:alertDelete(<?= $data['id_absen_guru'] ?>);" class="btn btn-danger m1">
					<svg style="width:20px;height:20px" viewBox="0 0 24 24" class="mb-1">
...
function alertDelete(idn) {
	$('#deleteButtonModal').attr('href', '<?= $WEB_CONFIG['base_url'] ?>index8.php?page=delete&id_absen_guru='+idn);
