...
<body>
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-md-2">
				<h2 class='text-uppercase'><?= $content ?> Data kurikulum SMK</h2>
			</div>
			<div class="col-md-10">
			<?php
			...
			switch ($content) {
				case 'add':
					require 'operasik/createk.php';
					break;
				case 'delete':
					require 'operasik/deletek.php';
					break;
				case 'update':
					require 'operasik/updatek.php';
					break;
				default:
					require 'operasik/readk.php';
					break;
			} ?>
			</div>
		</div>
