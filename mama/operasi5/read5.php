...
<body>
    <a href="<?= $WEB_CONFIG['base_url'] ?>index5.php?page=add" class="btn btn-primary mb-3">
...
<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
		...
		<tbody>
			...
			<tr>
				...
				<td><?= $data['jumlah'] ?></td>
				<td>
					<a href="<?= $WEB_CONFIG['base_url'] ?>index5.php?page=update&id_SPP=<?= $data['id_SPP'] ?>" class="btn btn-success m-1">
					...
					<a href="javascript:alertDelete(<?= $data['id_SPP'] ?>);" class="btn btn-danger m1">
					<svg style="width:20px;height:20px" viewBox="0 0 24 24" class="mb-1">
...
function alertDelete(idn) {
	$('#deleteButtonModal').attr('href', '<?= $WEB_CONFIG['base_url'] ?>index5.php?page=delete&id_SPP='+idn);
