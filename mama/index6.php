...
<body>
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-md-2">
				<h2 class='text-uppercase'><?= $content ?> Data ekstrakulikuler SMK</h2>
			</div>
			<div class="col-md-10">
			<?php
			...
			switch ($content) {
				case 'add':
					require 'operasi6/create6.php';
					break;
				case 'delete':
					require 'operasi6/delete6.php';
					break;
				case 'update':
					require 'operasi6/update6.php';
					break;
				default:
					require 'operasi6/read6.php';
					break;
			} ?>
			</div>
		</div>
