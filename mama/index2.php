...
<body>
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-md-2">
				<h2 class='text-uppercase'><?= $content ?> Data Kepala Sekolah SMK</h2>
			</div>
			<div class="col-md-10">
			<?php
			...
			switch ($content) {
				case 'add':
					require 'operasi2/create2.php';
					break;
				case 'delete':
					require 'operasi2/delete2.php';
					break;
				case 'update':
					require 'operasi2/update2.php';
					break;
				default:
					require 'operasi2/read2.php';
					break;
			} ?>
			</div>
		</div>
