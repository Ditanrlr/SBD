...
<body>
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-md-2">
				<h2 class='text-uppercase'><?= $content ?> Data orang_tua SMK</h2>
			</div>
			<div class="col-md-10">
			<?php
			...
			switch ($content) {
				case 'add':
					require 'operasi4/create4.php';
					break;
				case 'delete':
					require 'operasi4/delete4.php';
					break;
				case 'update':
					require 'operasi4/update4.php';
					break;
				default:
					require 'operasi4/read4.php';
					break;
			} ?>
			</div>
		</div>
