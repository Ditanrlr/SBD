<?php 
$query = "SELECT * FROM orang_tua ORDER BY id_orang_tua DESC";
...
<head>
	...
	<title>Data orang_tua SMK</title>
...
<body>
    <a href="<?= $WEB_CONFIG['base_url'] ?>index4.php?page=add" class="btn btn-primary mb-3">
...
<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
        ...
        <td><?= $data['tempat_tanggal_lahir'] ?></td>
				<td>
					<a href="<?= $WEB_CONFIG['base_url'] ?>index4.php?page=update&id_orang_tua=<?= $data['id_orang_tua'] ?>" class="btn btn-success m-1">
					...
					<a href="javascript:alertDelete(<?= $data['id_orang_tua'] ?>);" class="btn btn-danger m1">
					<svg style="width:20px;height:20px" viewBox="0 0 24 24" class="mb-1">
...
function alertDelete(idn) {
	$('#deleteButtonModal').attr('href', '<?= $WEB_CONFIG['base_url'] ?>index4.php?page=delete&id_orang_tua='+idn);
