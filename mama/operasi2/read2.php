<?php 
$query = "SELECT * FROM kepala_sekolah ORDER BY id_kepala_sekolah DESC";
...
<body>
    <a href="<?= $WEB_CONFIG['base_url'] ?>index2.php?page=add" class="btn btn-primary mb-3">
...
<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
        ...
        <td><?= $data['Agama'] ?></td>
				<td>
					<a href="<?= $WEB_CONFIG['base_url'] ?>index2.php?page=update&id_kepala_sekolah=<?= $data['id_kepala_sekolah'] ?>" class="btn btn-success m-1">
					...
					<a href="javascript:alertDelete(<?= $data['id_kepala_sekolah'] ?>);" class="btn btn-danger m1">
					<svg style="width:20px;height:20px" viewBox="0 0 24 24" class="mb-1">
...
function alertDelete(idn) {
	$('#deleteButtonModal').attr('href', '<?= $WEB_CONFIG['base_url'] ?>index2.php?page=delete&id_guru='+idn);
