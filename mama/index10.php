...
<body>
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-md-2">
				<h2 class='text-uppercase'><?= $content ?> Data nilai SMK</h2>
			</div>
			<div class="col-md-10">
			<?php
			...
			switch ($content) {
				case 'add':
					require 'operasi10/create10.php';
					break;
				case 'delete':
					require 'operasi10/delete10.php';
					break;
				case 'update':
					require 'operasi10/update10.php';
					break;
				default:
					require 'operasi10/read10.php';
					break;
			} ?>
			</div>
		</div>
