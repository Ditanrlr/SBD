...
<body>
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-md-2">
				<h2 class='text-uppercase'><?= $content ?> Data SPP SMK</h2>
			</div>
			<div class="col-md-10">
			<?php
			...
			switch ($content) {
				case 'add':
					require 'operasi5/create5.php';
					break;
				case 'delete':
					require 'operasi5/delete5.php';
					break;
				case 'update':
					require 'operasi5/update5.php';
					break;
				default:
					require 'operasi5/read5.php';
					break;
			} ?>
			</div>
		</div>
